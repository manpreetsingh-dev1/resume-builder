    ...
    <div className='space-y-4'>
      ...
      <p className='text-sm text-gray-500'>Add your technical Skills</p>
       ...
       <div className='flex gap-2'>
        <input type="text" placeholder='Enter a Skill' className='flex-1 px-3 py-2 text-sm ' onChange={(e)=>setNewSkill(e.target.value)}
        value={newSkill}
        onKeyDown={handlekeyPress} />
        <button onClick={addSkill} disabled={!newSkill.trim} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transform-colors disabled::opacity-50 disabled:cursor-allowed'>
